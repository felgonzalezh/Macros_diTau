...
void ZprimeYields(){
  ...
  */
  ...
  TFile *f1 = TFile::Open("newDMF_newTightIso_LooseElectron_TightMuon/SR/Zprime3000.root","READ");
  if (f1 == 0) {
  ...
  TFile *f2 = TFile::Open("newDMF_newTightIso_LooseElectron_TightMuon_TAUPOG_NewTriggerSF/SR/Zprime3000.root","READ");
  if (f2 == 0) {
    printf("Error: cannot open Zprime3000 \n");
    return;
    }
  ...
  //--------------FIRSTPAD
  H_Mass_3000->SetTitle("Comparison our Trigger Method- TAUPOG Trigger Method on MC for Zprime");
