...
void QCDYields(){
  ...
  */
  /*
  int nb = 9;
  float BINS[10] = {200.0, 225.0, 250.0, 300.0, 350.0, 450.0, 600.0, 750.0, 900.0, 1200.0};  
  double BINNER[10] = {200.0, 225.0, 250.0, 300.0, 350.0, 450.0, 600.0, 750.0, 900.0, 1200.0};  
  */
  /*
  int nb = 11;
  ...
  */
  ...
  int nb = 10;
  float BINS[11] = {0.0,200.0, 225.0, 250.0, 300.0, 350.0, 450.0, 600.0, 750.0, 900.0, 1200.0};  
  double BINNER[11] = {0.0,200.0, 225.0, 250.0, 300.0, 350.0, 450.0, 600.0, 750.0, 900.0, 1200.0};  
  ...
  */
  ...
  TFile *f1 = TFile::Open("newDMF_newTightIso_LooseElectron_TightMuon/SR/QCD.root","READ");
  if (f1 == 0) {
  ...
  TFile *f2 = TFile::Open("newDMF_newTightIso_LooseElectron_TightMuon_TAUPOG_NewTriggerSF/SR/QCD.root","READ");
  if (f2 == 0) {
    printf("Error: cannot open Zprime3000 \n");
    return;
    }
  ...
  //--------------FIRSTPAD
  H_Mass_3000->SetTitle("Comparison our Trigger Method- TAUPOG Trigger Method on MC for QCD");
